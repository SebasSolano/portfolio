<script setup>
  const projects = [
    ...
    {
      title: "Spotify Clone",
      description: "This is a spotify semi-clone to learn more about Astro.",
      image: "/projects/veterinariaAPP.jpg",
      technologies: ["Astro", "TypeScript", "JavaScript", "Svelte"],
      link: "",
      github: "https://github.com/SebasSolano/spotify-clone-course",
      category: "Courses",
      type: ["Frontend"],
      finished: true,
      collaboration: false,
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div v-for="project in projects" :key="project.title" class="relative">
          <div
            ...
            class="absolute z-10 -top-6 bg-primary-200/30 backdrop-blur-lg rounded-xl p-2 shadow-md border border-primary-200/20 cursor-pointer"
          >
            <p>Main Project</p>
          </div>
          ...
          >
            <div class="relative">
              <div
                v-if="project.image === '' && !project.finished"
